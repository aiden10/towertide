...
@onready var item_name: Label = $InfoContainer/PanelContainer/MarginContainer/VBoxContainer/ItemName
@onready var item_description: Label = $InfoContainer/PanelContainer/MarginContainer/VBoxContainer/ItemName
